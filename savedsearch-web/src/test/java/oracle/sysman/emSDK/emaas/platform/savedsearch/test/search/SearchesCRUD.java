...
public class SearchesCRUD
{
	...
	public static void createinitObject() throws Exception
	{
		...
		Response res = RestAssured.given().contentType(ContentType.JSON).log().everything().header("Authorization", authToken)
				.header(TestConstant.SSF_HEADER, TestConstant.SSF_HEADER).header(TestConstant.OAM_HEADER, TENANT_ID1)
		...
		Response res3 = RestAssured.given().contentType(ContentType.XML).log().everything().header("Authorization", authToken)
				.header(TestConstant.SSF_HEADER, TestConstant.SSF_HEADER).header(TestConstant.OAM_HEADER, TENANT_ID1)
				.body(jsonString3).when().post("/importcategories");
		Assert.assertEquals(res1.getStatusCode(), 200);
	...
	public void flattenedFolderPath()
	{
		try {
			...
			Response res2 = RestAssured.given().contentType(ContentType.JSON).log().everything()
					.header("Authorization", authToken).header(TestConstant.SSF_HEADER, TestConstant.SSF_HEADER)
					.header(TestConstant.OAM_HEADER, TENANT_ID1).body(jsonString2).when().post("/search");
			...
			Response res5 = RestAssured.given().contentType(ContentType.JSON).log().everything()
					.header("Authorization", authToken).header(TestConstant.SSF_HEADER, TestConstant.SSF_HEADER)
					.header(TestConstant.OAM_HEADER, TENANT_ID1).when().delete("/folder/" + jp1.get("id"));
			System.out.println("											");
	...
	public void lastaccessedSearches_invalidObjects1()
	{
		try {
			...
			Response res = RestAssured.given().contentType(ContentType.JSON).log().everything()
					.header("Authorization", authToken).header(TestConstant.SSF_HEADER, TestConstant.SSF_HEADER)
					.header(TestConstant.OAM_HEADER, TENANT_ID1).when().get("/search/10000000087?updateLastAccessTime=true");
			System.out.println(res.asString());
	...
	public void lastaccessedSearches_invalidObjects3()
	{
		try {
			...
			Response res = RestAssured.given().contentType(ContentType.JSON).log().everything()
					.header("Authorization", authToken).header(TestConstant.SSF_HEADER, TestConstant.SSF_HEADER)
					.header(TestConstant.OAM_HEADER, TENANT_ID1).when().delete("/search/1000000087?updateLastAccessTime=true");
			System.out.println(res.asString());
			System.out.println("Status code is: " + res.getStatusCode());
	...
	public void lastaccessedSearches_invalidObjects4()
	{
		try {
			...
			Response res = RestAssured.given().contentType(ContentType.JSON).log().everything()
					.header("Authorization", authToken).header(TestConstant.SSF_HEADER, TestConstant.SSF_HEADER)
					.header(TestConstant.OAM_HEADER, TENANT_ID1).when().put("/search/100000000087?updateLastAccessTime=true");
			System.out.println(res.asString());
			System.out.println("Status code is: " + res.getStatusCode());
	...
	public void returnAlllastaccessedSearches()
	{
		try {
			...
			Response res = RestAssured.given().contentType(ContentType.JSON).log().everything()
					.header("Authorization", authToken).header(TestConstant.SSF_HEADER, TestConstant.SSF_HEADER)
					.header(TestConstant.OAM_HEADER, TENANT_ID1).when().get("/searches/");
			System.out.println("Status code is: " + res.getStatusCode());
	...
	public void returnNolastaccessedSearches()
	{
		try {
			...
			Response res = RestAssured.given().contentType(ContentType.JSON).log().everything()
					.header("Authorization", authToken).header(TestConstant.SSF_HEADER, TestConstant.SSF_HEADER)
					.header(TestConstant.OAM_HEADER, TENANT_ID1).when().get("/searches?lastAccessCount=0");
	...
	public void returnNolastaccessedSearches_NegCount()
	{
		try {
			...
			Response res = RestAssured.given().contentType(ContentType.JSON).log().everything()
					.header("Authorization", authToken).header(TestConstant.SSF_HEADER, TestConstant.SSF_HEADER)
					.header(TestConstant.OAM_HEADER, TENANT_ID1).when().get("/searches?lastAccessCount=-1");
			// JsonPath jp = res.jsonPath();
			// System.out.println(res.asString());
			System.out.println("Status code is: " + res.getStatusCode());
			Assert.assertEquals(res.asString(), "Id/count should be a positive number and not an alphanumeric");
	...
	public void returnNolastaccessedSearches_textCount()
	{
		try {
			...
			Response res = RestAssured.given().contentType(ContentType.JSON).log().everything()
					.header("Authorization", authToken).header(TestConstant.SSF_HEADER, TestConstant.SSF_HEADER)
					.header(TestConstant.OAM_HEADER, TENANT_ID1).when().get("/searches?lastAccessCount=sravan");
			// JsonPath jp = res.jsonPath();
			// System.out.println(res.asString());
			System.out.println("Status code is: " + res.getStatusCode());
			Assert.assertEquals(res.asString(), "Id/count should be a positive number and not an alphanumeric");
	...
	public void search_create()
	{
		try {
			...
			Response res = RestAssured.given().log().everything().header("Authorization", authToken)
					.header(TestConstant.SSF_HEADER, TestConstant.SSF_HEADER).header(TestConstant.OAM_HEADER, TENANT_ID1).when()
					.get("/entities?folderId=" + folderid);
			JsonPath jp = res.jsonPath();
			System.out.println("											");
			System.out.println("Status code is: " + res.getStatusCode());
			System.out.println("											");
		...
		try {
			...
			for (int i = 0; i < a.size(); i++) {
				if (a.get(i).equals("Custom_Search")) {
					...
					Response res1 = RestAssured.given().contentType(ContentType.JSON).log().everything()
							.header("Authorization", authToken).header(TestConstant.SSF_HEADER, TestConstant.SSF_HEADER)
							.header(TestConstant.OAM_HEADER, TENANT_ID1).body(jsonString).when().put("/search/" + searchID);
					System.out.println("											");
					System.out.println("Status code is: " + res1.getStatusCode());
					System.out.println("											");
					System.out.println(res1.asString());
	...
	public void search_edit_categoryId()
	{
		try {
			...
			Response res2 = RestAssured.given().contentType(ContentType.JSON).log().everything()
					.header("Authorization", authToken).header(TestConstant.SSF_HEADER, TestConstant.SSF_HEADER)
					.header(TestConstant.OAM_HEADER, TENANT_ID1).header("X_SSF_API_AUTH", "ORACLE_INTERNAL").body(jsonString1)
			...
			Response res3 = RestAssured.given().contentType(ContentType.JSON).log().everything()
					.header("Authorization", authToken).header(TestConstant.SSF_HEADER, TestConstant.SSF_HEADER)
					.header(TestConstant.OAM_HEADER, TENANT_ID1).header("X_SSF_API_AUTH", "ORACLE_INTERNAL").body(jsonString2)
					.when().put("/search/" + jp.get("id"));
			JsonPath jp3 = res3.jsonPath();
			System.out.println("											");
			System.out.println("Status code is: " + res3.getStatusCode());
			...
			Response res4 = RestAssured.given().contentType(ContentType.JSON).log().everything()
					.header("Authorization", authToken).header(TestConstant.SSF_HEADER, TestConstant.SSF_HEADER)
					.header(TestConstant.OAM_HEADER, TENANT_ID1).header("X_SSF_API_AUTH", "ORACLE_INTERNAL").body(jsonString3)
					.when().put("/search/" + jp.get("id"));
			...
			Response res7 = RestAssured.given().contentType(ContentType.JSON).log().everything()
					.header("Authorization", authToken).header(TestConstant.SSF_HEADER, TestConstant.SSF_HEADER)
					.header(TestConstant.OAM_HEADER, TENANT_ID1).when().delete("/search/" + jp.get("id"));
	...
	public void search_edit_emptyFolderId()
	{
		try {
			...
			Response res2 = RestAssured.given().contentType(ContentType.JSON).log().everything()
					.header("Authorization", authToken).header(TestConstant.SSF_HEADER, TestConstant.SSF_HEADER)
					.header(TestConstant.OAM_HEADER, TENANT_ID1).body(jsonString_edit).when().put("/search/" + jp.get("id"));
			System.out.println(res2.asString());
			Assert.assertTrue(res2.getStatusCode() == 400);
	...
	public void search_edit_invalidParam()
	{
		try {
			...
			Response res3 = RestAssured.given().contentType(ContentType.JSON).log().everything()
					.header("Authorization", authToken).header(TestConstant.SSF_HEADER, TestConstant.SSF_HEADER)
					.header(TestConstant.OAM_HEADER, TENANT_ID1).body(jsonString_edit1).when().put("/search/" + jp.get("id"));
			System.out.println(res3.asString());
			...
			Response res4 = RestAssured.given().contentType(ContentType.JSON).log().everything()
					.header("Authorization", authToken).header(TestConstant.SSF_HEADER, TestConstant.SSF_HEADER)
					.header(TestConstant.OAM_HEADER, TENANT_ID1).body(jsonString_edit2).when().put("/search/" + jp.get("id"));
			System.out.println(res4.asString());
			...
			Response res5 = RestAssured.given().contentType(ContentType.JSON).log().everything()
					.header("Authorization", authToken).header(TestConstant.SSF_HEADER, TestConstant.SSF_HEADER)
					.header(TestConstant.OAM_HEADER, TENANT_ID1).body(jsonString_edit3).when().put("/search/" + jp.get("id"));
			System.out.println(res5.asString());
	...
	public void search_missingMandateinfo()
	{
		try {
			 ...
			 * .log()
			 * .everything().header("Authorization", authToken).header(TestConstant.SSF_HEADER, TestConstant.SSF_HEADER).header(TestConstant.OAM_HEADER, TENANT_ID1).body(jsonString1).when().post("/search");
			 * System.out.println("											");
			 * System.out.println("Status code is: " + res1.getStatusCode());
			 * System.out.println("											");
			 * System.out.println(res1.asString());
			...
			Response res3 = RestAssured.given().contentType(ContentType.JSON).log().everything()
					.header("Authorization", authToken).header(TestConstant.SSF_HEADER, TestConstant.SSF_HEADER)
					.header(TestConstant.OAM_HEADER, TENANT_ID1).body(jsonString3).when().post("/search");
			System.out.println("											");
			System.out.println("Status code is: " + res3.getStatusCode());
			System.out.println("											");
			System.out.println(res3.asString());
			...
			Response res4 = RestAssured.given().contentType(ContentType.JSON).log().everything()
					.header("Authorization", authToken).header(TestConstant.SSF_HEADER, TestConstant.SSF_HEADER)
					.header(TestConstant.OAM_HEADER, TENANT_ID1).body(jsonString4).when().post("/search");
			System.out.println("											");
			System.out.println("Status code is: " + res4.getStatusCode());
			System.out.println("											");
			System.out.println(res4.asString());
			...
			Response res5 = RestAssured.given().contentType(ContentType.JSON).log().everything()
					.header("Authorization", authToken).header(TestConstant.SSF_HEADER, TestConstant.SSF_HEADER)
					.header(TestConstant.OAM_HEADER, TENANT_ID1).body(jsonString5).when().post("/search");
			System.out.println("											");
			System.out.println("Status code is: " + res5.getStatusCode());
			System.out.println("											");
			System.out.println(res5.asString());
	...
	public void setlastaccesstime_Tosearch()
	{
		try {
			...
			Response res1 = RestAssured.given().contentType(ContentType.JSON).log().everything()
					.header("Authorization", authToken).header(TestConstant.SSF_HEADER, TestConstant.SSF_HEADER)
					.header(TestConstant.OAM_HEADER, TENANT_ID1).body(jsonString1).when().post("/search");
			JsonPath jp1 = res1.jsonPath();
			System.out.println("											");
			System.out.println("Status code is: " + res1.getStatusCode());
			System.out.println("											");
			...
			Response res3 = RestAssured.given().contentType(ContentType.JSON).log().everything()
					.header("Authorization", authToken).header(TestConstant.SSF_HEADER, TestConstant.SSF_HEADER)
					.header(TestConstant.OAM_HEADER, TENANT_ID1).when().get("/searches?lastAccessCount=2");
			JsonPath jp3 = res3.jsonPath();
			// System.out.println(res3.asString());
			...
			Response res4_1 = RestAssured.given().contentType(ContentType.JSON).log().everything()
					.header("Authorization", authToken).header(TestConstant.SSF_HEADER, TestConstant.SSF_HEADER)
					.header(TestConstant.OAM_HEADER, TENANT_ID1).when().get("/search/" + jp3.get("id[1]"));
			...
			Response res4_4 = RestAssured.given().contentType(ContentType.JSON).log().everything()
					.header("Authorization", authToken).header(TestConstant.SSF_HEADER, TestConstant.SSF_HEADER)
					.header(TestConstant.OAM_HEADER, TENANT_ID1).when().get("/search/" + jp3.get("id[0]"));
			...
			Response res6 = RestAssured.given().contentType(ContentType.JSON).log().everything()
					.header("Authorization", authToken).header(TestConstant.SSF_HEADER, TestConstant.SSF_HEADER)
					.header(TestConstant.OAM_HEADER, TENANT_ID1).when().delete("/search/" + jp1.get("id"));
	...
	public void setlastaccesstime_Tosearch_badParameter()
	{
		try {
			...
			Response res2 = RestAssured.given().contentType(ContentType.JSON).log().everything()
					.header("Authorization", authToken).header(TestConstant.SSF_HEADER, TestConstant.SSF_HEADER)
					.header(TestConstant.OAM_HEADER, TENANT_ID1).when().put("/search/" + jp1.get("id") + "?updateLastAccessTime");
			...
			Response res3 = RestAssured.given().contentType(ContentType.JSON).log().everything()
					.header("Authorization", authToken).header(TestConstant.SSF_HEADER, TestConstant.SSF_HEADER)
					.header(TestConstant.OAM_HEADER, TENANT_ID1).when().put("/search/" + jp1.get("id"));
	...
	{		try {
			...
			Response res = RestAssured.given().log().everything().header("Authorization", authToken).header(TestConstant.SSF_HEADER, TestConstant.SSF_HEADER).header(TestConstant.OAM_HEADER, TENANT_ID1)
			...
			Response res1 = RestAssured.given().contentType(ContentType.JSON).log().everything()
					.header("Authorization", authToken).header(TestConstant.SSF_HEADER, TestConstant.SSF_HEADER).header(TestConstant.OAM_HEADER, TENANT_ID1).when()
	...
	/*public void systemSearch_edit()
	{
		try {
			...
			Response res1 = RestAssured.given().contentType(ContentType.JSON).log().everything()
					.header("Authorization", authToken).header(TestConstant.SSF_HEADER, TestConstant.SSF_HEADER).header(TestConstant.OAM_HEADER, TENANT_ID1).body(jsonString).when()
