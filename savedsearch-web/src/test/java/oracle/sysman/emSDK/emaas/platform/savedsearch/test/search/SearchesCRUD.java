...
public class SearchesCRUD
{
	...
	public void flattenedFolderPath()
	{
		try {
			...
			Response res1 = RestAssured.given().contentType(ContentType.JSON).headers("X-USER-IDENTITY-DOMAIN-NAME", HOSTNAME)
					.log().everything().body(jsonString).when().post("/folder");
			...
			Response res3 = RestAssured.given().headers("X-USER-IDENTITY-DOMAIN-NAME", HOSTNAME).log().everything().when()
			...
			Response res4 = RestAssured.given().contentType(ContentType.JSON).headers("X-USER-IDENTITY-DOMAIN-NAME", HOSTNAME)
					.log().everything().when().delete("/search/" + jp2.get("id"));
			// System.out.println(res4.asString());
			System.out.println("Status code is: " + res4.getStatusCode());
			System.out.println("											");
			...
			Response res5 = RestAssured.given().contentType(ContentType.JSON).headers("X-USER-IDENTITY-DOMAIN-NAME", HOSTNAME)
					.log().everything().when().delete("/folder/" + jp1.get("id"));
			System.out.println("											");
			System.out.println("Status code is: " + res5.getStatusCode());
			// System.out.println("											");
			// System.out.println(res5.asString());
	...
	public void lastaccessedSearches_invalidObjects1()
	{
		try {
			...
			Response res = RestAssured.given().contentType(ContentType.JSON).headers("X-USER-IDENTITY-DOMAIN-NAME", HOSTNAME)
					.log().everything().when().get("/search/10000000087?updateLastAccessTime=true");
			System.out.println(res.asString());
			System.out.println("Status code is: " + res.getStatusCode());
	...
	public void lastaccessedSearches_invalidObjects3()
	{
		try {
			...
			System.out.println("											");
			Response res = RestAssured.given().contentType(ContentType.JSON).headers("X-USER-IDENTITY-DOMAIN-NAME", HOSTNAME)
					.log().everything().when().delete("/search/1000000087?updateLastAccessTime=true");
			System.out.println(res.asString());
			System.out.println("Status code is: " + res.getStatusCode());
	...
	public void lastaccessedSearches_invalidObjects4()
	{
		try {
			...
			System.out.println("											");
			Response res = RestAssured.given().contentType(ContentType.JSON).headers("X-USER-IDENTITY-DOMAIN-NAME", HOSTNAME)
					.log().everything().when().put("/search/100000000087?updateLastAccessTime=true");
			System.out.println(res.asString());
			System.out.println("Status code is: " + res.getStatusCode());
	...
	public void returnAlllastaccessedSearches()
	{
		try {
			...
			System.out.println("											");
			Response res = RestAssured.given().contentType(ContentType.JSON).headers("X-USER-IDENTITY-DOMAIN-NAME", HOSTNAME)
					.log().everything().when().get("/searches/");
			// System.out.println(res.asString());
	...
	public void returnNolastaccessedSearches()
	{
		try {
			...
			System.out.println("											");
			Response res = RestAssured.given().contentType(ContentType.JSON).headers("X-USER-IDENTITY-DOMAIN-NAME", HOSTNAME)
					.log().everything().when().get("/searches?lastAccessCount=0");
			// JsonPath jp = res.jsonPath();
			// System.out.println(res.asString());
			System.out.println("Status code is: " + res.getStatusCode());
	...
	public void returnNolastaccessedSearches_NegCount()
	{
		try {
			...
			System.out.println("											");
			Response res = RestAssured.given().contentType(ContentType.JSON).headers("X-USER-IDENTITY-DOMAIN-NAME", HOSTNAME)
					.log().everything().when().get("/searches?lastAccessCount=-1");
			// JsonPath jp = res.jsonPath();
			// System.out.println(res.asString());
			System.out.println("Status code is: " + res.getStatusCode());
	...
	public void returnNolastaccessedSearches_textCount()
	{
		try {
			...
			System.out.println("											");
			Response res = RestAssured.given().contentType(ContentType.JSON).headers("X-USER-IDENTITY-DOMAIN-NAME", HOSTNAME)
					.log().everything().when().get("/searches?lastAccessCount=sravan");
			// JsonPath jp = res.jsonPath();
			// System.out.println(res.asString());
			System.out.println("Status code is: " + res.getStatusCode());
			Assert.assertEquals(res.asString(), "Id/count should be a positive number and not an alphanumeric.");
		...
		try {
			...
			for (int i = 0; i < a.size(); i++) {
				if (a.get(i).equals("Custom_Search_Edit")) {
					...
					Response res0 = RestAssured.given().headers("X-USER-IDENTITY-DOMAIN-NAME", HOSTNAME).log().everything()
	...
	public void setlastaccesstime_Tosearch()
	{
		try {
			...
			System.out.println("											");
			Response res3 = RestAssured.given().contentType(ContentType.JSON).headers("X-USER-IDENTITY-DOMAIN-NAME", HOSTNAME)
					.log().everything().when().get("/searches?lastAccessCount=2");
			JsonPath jp3 = res3.jsonPath();
			// System.out.println(res3.asString());
			...
			Response res4 = RestAssured.given().contentType(ContentType.JSON).headers("X-USER-IDENTITY-DOMAIN-NAME", HOSTNAME)
					.log().everything().when().put("/search/" + jp3.get("id[1]") + "?updateLastAccessTime=true");
			...
			Response res6 = RestAssured.given().contentType(ContentType.JSON).headers("X-USER-IDENTITY-DOMAIN-NAME", HOSTNAME)
					.log().everything().when().delete("/search/" + jp5.get("id[0]"));
			// JsonPath jp6 = res6.jsonPath();
			System.out.println(res6.asString());
			Assert.assertTrue(res6.getStatusCode() == 204);
			Response res7 = RestAssured.given().contentType(ContentType.JSON).headers("X-USER-IDENTITY-DOMAIN-NAME", HOSTNAME)
					.log().everything().when().delete("/search/" + jp5.get("id[1]"));
