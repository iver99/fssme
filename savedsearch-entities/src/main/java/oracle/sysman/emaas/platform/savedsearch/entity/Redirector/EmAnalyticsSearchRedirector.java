...
public class EmAnalyticsSearchRedirector implements QueryRedirector{
	...
	public Object invokeQuery(DatabaseQuery query, Record arguments,
		...
		if (query.isDeleteObjectQuery()) {
			if (!Boolean.TRUE.equals(permanant)) {
				...
				EmAnalyticsSearch emObject = (EmAnalyticsSearch) doq.getObject();
				emObject.setDeleted(emObject.getId());
