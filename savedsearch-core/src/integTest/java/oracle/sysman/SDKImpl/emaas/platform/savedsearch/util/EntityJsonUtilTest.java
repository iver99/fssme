...
public class EntityJsonUtilTest {
    ...
    @Test(expectedExceptions = {EMAnalyticsFwkException.class})
    public void getWidgetGroupJsonObjJSONException(@Mocked JSONUtil jsonUtil, @Mocked final Category category) throws EMAnalyticsFwkException, JSONException {
        new Expectations(){
            {
                category.getId();
                result = new JSONException(throwable);
    ...
    @Test(expectedExceptions = {EMAnalyticsFwkException.class})
    public void getWidgetJsonObjJSONException(@Mocked JSONUtil jsonUtil, @Mocked final Search search) throws EMAnalyticsFwkException, JSONException {
        new Expectations(){
            {
                search.getId();
                result = new JSONException(throwable);
