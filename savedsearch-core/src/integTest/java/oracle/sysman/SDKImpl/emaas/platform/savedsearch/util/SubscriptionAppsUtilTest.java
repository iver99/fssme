...
public class SubscriptionAppsUtilTest {
    ...
    public void testSubsriptionApps2UtilV1_V2(){
        ...
        subscriptionApps.setVersion(SubsriptionApps2Util.V1_TENANT);
        ...
        subscriptionApps1.setVersion(SubsriptionApps2Util.V2_TENANT);
    ...
    public void testSubsriptionApps2UtilV3(){
        ...
        subscriptionApps5.setTenantName(SubsriptionApps2Util.V3_TENANT);
        ...
        subscriptionApps6.setTenantName(SubsriptionApps2Util.V3_TENANT);
