...
public class DataProviderClass {
	...
	/*@DataProvider(name = "cache_unit_not_available")
	public static Object[][] providesNotAvailableCacheUnit() {
		CacheUnit cu=new CacheUnit();
		cu.setIsAvailable(false);
	...
	/*@DataProvider(name = "cache_unit_cache1")
	public static Object[][] providesCache1() {
		return new Object[][] { { new CacheUnit("cache1") } };
	}
	
	@DataProvider(name = "cache_unit_cache1_3sec")
	public static Object[][] providesEmptyDeque() {
		return new Object[][] { { new CacheUnit("cache1",3) } };
	}*/
