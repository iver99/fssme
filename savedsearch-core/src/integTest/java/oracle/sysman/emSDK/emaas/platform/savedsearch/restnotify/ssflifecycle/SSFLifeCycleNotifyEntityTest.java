...
public class SSFLifeCycleNotifyEntityTest {
	...
	public void testSSFLifeCycleNotifyEntity() {
		...
		lcne = new SSFLifeCycleNotifyEntity(SSFLifeCycleNotifyEntity.SSFNotificationType.DOWN);
		Assert.assertEquals(lcne.getType(), SSFLifeCycleNotifyEntity.SSFNotificationType.DOWN);
	}
