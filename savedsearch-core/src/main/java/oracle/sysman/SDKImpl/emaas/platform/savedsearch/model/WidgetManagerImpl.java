...
public class WidgetManagerImpl extends WidgetManager
{
	...
	private static final String SQL_WIDGET_LIST_BY_PROVIDERS_1 = "SELECT s.SEARCH_ID,s.CREATION_DATE,s.LAST_MODIFICATION_DATE, s.NAME, s.DESCRIPTION, s.OWNER, "
			...
			+ "s.CREATION_DATE, s.LAST_MODIFICATION_DATE, s.FEDERATION_SUPPORTED, s.GREENFIELD_SUPPORTED, c.NAME as CATOGORY_NAME, "
	...
	private static final String SQL_WIDGET_LIST_BY_PROVIDERS_4_GF = "AND s.GREENFIELD_SUPPORTED=1 ";
	private static final String SQL_WIDGET_LIST_BY_PROVIDERS_4_FED = "AND s.FEDERATION_SUPPORTED=1 ";
