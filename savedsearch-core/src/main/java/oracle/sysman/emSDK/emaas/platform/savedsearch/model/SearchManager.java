 ...
 *  @see Search
 *  
 *  @version $Header: emcore/jsrc/sdkcore/SdkcoreEmanalyticsPublicModel/src/oracle/sysman/emSDK/core/emanalytics/api/search/SearchManager.java /st_emgc_pt-13.1mstr/2 2014/02/03 02:51:01 saurgarg Exp $
 *  @author  saurgarg
 *  @since   13.1.0.0
 */
public abstract class SearchManager
{
     ...
     * 
     * @param search search to be modified
     ...
     * @throws EMAnalyticsFwkException
     */
    public abstract void deleteSearch(long searchId) throws EMAnalyticsFwkException;
    
    /**
     * Returns the search object identified by the given identifier.
     * 
     * @param searchId identifier for the search entity
     * @return search
     * @throws EMAnalyticsFwkException
     */
