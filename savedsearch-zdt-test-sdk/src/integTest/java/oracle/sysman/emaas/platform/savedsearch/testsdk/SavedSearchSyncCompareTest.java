...
public class SavedSearchSyncCompareTest
{
	...
	public void testFullCompare() throws SQLException
	{
		...
		try {
			...
			RestAssured.basePath = "/emcpssfcomparator/api/v1/comparator/compare?";
	...
	public void testFullSyncStatus()
	{
		try {
			RestAssured.baseURI = "http://" + HOSTNAME + ":" + "8022";
			RestAssured.basePath = "/emcpssfcomparator/api/v1/comparator/sync/status";
			Response res = RestAssured
					.given()
					.log()
					.everything()
	...
	public void testIncrementalSync()
	{
		try {
			RestAssured.baseURI = "http://" + HOSTNAME + ":" + "8022";
			RestAssured.basePath = "/emcpssfcomparator/api/v1/comparator/sync";
			Response res = RestAssured
					.given()
					.log()
					.everything()
