 ...
 * @author miayu
 */
public class SavedsearchComparatorCORSFilter implements Filter
{
	...
	private static final Logger logger = LogManager.getLogger(SavedsearchComparatorCORSFilter.class);
