...
public class RegistryServiceManager implements ApplicationServiceManager
{
	...
	private static final String NAV_BASE = "/emcpssfcomparator/api/v1/comparator";
	...
	public boolean registerService()
	{
		try {
			...
			logger.info("Service manager is up. Completed SavedSearch-Comparator registration");
		}
		catch (Exception e) {
			setRegistrationComplete(Boolean.FALSE);
			logger.error(
					"Errors occurrs in registration. Service manager might be down. SavedSearch-Comparator registration is not complete.");
