...
{
	public static final String APPLICATION_LOGGER_SUBSYSTEM = "oracle.sysman.emaas.platform.savedsearch.comparator";
	...
	{
		logger.notice("Post-starting registered Savedsearch Comparator services");
		try {
	...
	{
		logger.notice("Post-stopping registered Savedsearch Comparator services");
		try {
	...
	{
		logger.debug("Pre-starting registered Savedsearch Comparator services");
		try {
	...
	{
		logger.debug("Pre-stopping registered Savedsearch Comparator services");
		try {
