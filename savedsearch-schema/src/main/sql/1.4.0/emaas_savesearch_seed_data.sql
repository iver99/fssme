...
BEGIN
  ...
  SELECT COUNT(1) INTO V_COUNT FROM EMS_ANALYTICS_SEARCH_PARAMS WHERE TENANT_ID='&TENANT_ID' AND SEARCH_ID=WIDGET_SEARCH_ID AND PARAM_TYPE=1 AND NAME ='EMS_DASHBOARD_TILE' AND PARAM_VALUE_STR =DASHBOARD_LINK_ID;
  IF (V_COUNT>0) THEN
