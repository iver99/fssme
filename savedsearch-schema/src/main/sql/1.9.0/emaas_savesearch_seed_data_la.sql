...
BEGIN
  ...
  Update EMS_ANALYTICS_SEARCH set SEARCH_DISPLAY_STR='''Target Type'' in (''Oracle Database Instance'', ''Automatic Storage Management'', ''Listener'', ''Oracle Clusterware'')' where SEARCH_ID=2002 and TENANT_ID='&TENANT_ID';
  ...
  Update EMS_ANALYTICS_SEARCH set SEARCH_DISPLAY_STR='''Target Type'' = ''Host (Linux)''' where SEARCH_ID=2004 and TENANT_ID='&TENANT_ID';
  Update EMS_ANALYTICS_SEARCH set SEARCH_DISPLAY_STR='''Target Type'' in (''Oracle Database Instance'', ''Automatic Storage Management'', ''Listener'', ''Oracle Clusterware'') and Severity in (''error'', ''severe'')  | stats count as ''Error Count'' by target | top limit=10 ''Error Count''' where SEARCH_ID=2005 and TENANT_ID='&TENANT_ID';
  ...
  Update EMS_ANALYTICS_SEARCH set SEARCH_DISPLAY_STR='''Target Type'' in (''WebLogic Server'', ''Oracle Internet Directory'',''Oracle HTTP Server'',''Oracle Access Management Server'',''WebLogic Domain'') and ''Error ID'' != ''bea-000000'' | stats count as ct by ''error id'' | top limit=10 ct' where SEARCH_ID=2010 and TENANT_ID='&TENANT_ID';
