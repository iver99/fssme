...
BEGIN
V_SEARCHID := 2002;
V_SEARCH_STR := '''Target Type'' in (''Oracle Database Instance'', ''Automatic Storage Management'', ''Listener'', ''Oracle Clusterware'')';
...
Update EMS_ANALYTICS_SEARCH set SEARCH_DISPLAY_STR=V_SEARCH_STR WHERE SEARCH_ID=V_SEARCHID and V_TENANT='&TENANT_ID';
V_SEARCHID := 2005;
V_SEARCH_STR := '''Target Type'' in (''Oracle Database Instance'', ''Automatic Storage Management'', ''Listener'', ''Oracle Clusterware'') and Severity in (''error'', ''severe'')  | stats count as ''Error Count'' by target | top limit=10 ''Error Count''';
Update EMS_ANALYTICS_SEARCH set SEARCH_DISPLAY_STR=V_SEARCH_STR WHERE SEARCH_ID=V_SEARCHID and V_TENANT='&TENANT_ID';
V_SEARCHID := 2006;
...
V_SEARCHID := 2013;
V_SEARCH_STR :='''Target Type'' in (''Oracle Database Instance'', ''Automatic Storage Management'', ''Listener'', ''Oracle Clusterware'') and ''Message Group'' in (''ORA'', ''NZE'', ''EXP'', ''IMP'', ''SQL*Loader'', ''KUP'', ''UDE'', ''UDI'', ''DBV'', ''NID'', ''DGM'', ''DIA'', ''LCD'', ''OCI'', ''QSM'', ''RMAN'', ''LRM'', ''LFI'', ''PLS'', ''PLW'', ''AMD'', ''CLSR'', ''CLSS'', ''CRS'', ''EVM'', ''CLST'', ''CLSD'', ''PROC'', ''PROT'', ''TNS'', ''NNC'', ''NNO'', ''NPL'', ''NNF'', ''NMP'', ''NCR'', ''O2F'', ''O2I'', ''O2U'', ''PCB'', ''PCC'', ''SQL'', ''AUD'', ''IMG'', ''VID'', ''DRG'', ''LPX'', ''LSX'', ''PGA'', ''PGU'') or ''Message Group'' LIKE ''%NNL''';
Update EMS_ANALYTICS_SEARCH set SEARCH_DISPLAY_STR=V_SEARCH_STR WHERE SEARCH_ID=V_SEARCHID and V_TENANT='&TENANT_ID';
...
V_SEARCHID := 2016;
V_SEARCH_STR :='''Target Type'' in (''Oracle Database Instance'', ''Automatic Storage Management'', ''Listener'', ''Oracle Clusterware'') and ''Error ID'' in ( ''ORA-00600'',''ORA-00603'',''ORA-07445'', ''ORA-04030'',''ORA-04031'',''ORA-00227'',''ORA-00239'', ''ORA-00240'',''ORA-00255'',''ORA-00353'', ''ORA-00355'',''ORA-00356'',''ORA-00445'',''ORA-00494'',''ORA-01578'', ''OCI-03106'',''ORA-03113'',''OCI-03113%'', ''OCI-03135'', ''ORA-03137'',''ORA-04036'',''ORA-24982'',''ORA-25319'', ''ORA-29740'',''ORA-29770'', ''ORA-29771'', ''ORA-32701'',''ORA-32703'',''ORA-32704'',''ORA-06512'', ''ORA-15173'' ) | stats count as ''Critical Errors'' by ''Target Type''';
Update EMS_ANALYTICS_SEARCH set SEARCH_DISPLAY_STR=V_SEARCH_STR WHERE SEARCH_ID=V_SEARCHID and V_TENANT='&TENANT_ID';   
