...
EXECUTE IMMEDIATE 'ALTER  TABLE EMS_ANALYTICS_LAST_ACCESS ADD TENANT_ID VARCHAR2(32)DEFAULT -1'; 
EXECUTE IMMEDIATE 'ALTER  TABLE EMS_ANALYTICS_FOLDERS ADD TENANT_ID VARCHAR2(32)DEFAULT -1'; 
EXECUTE IMMEDIATE 'ALTER  TABLE EMS_ANALYTICS_CATEGORY ADD TENANT_ID VARCHAR2(32)DEFAULT -1';
EXECUTE IMMEDIATE 'ALTER  TABLE EMS_ANALYTICS_CATEGORY_PARAMS ADD TENANT_ID VARCHAR2(32)DEFAULT -1';
EXECUTE IMMEDIATE 'ALTER  TABLE EMS_ANALYTICS_SEARCH ADD TENANT_ID VARCHAR2(32)DEFAULT -1'; 
EXECUTE IMMEDIATE 'ALTER  TABLE EMS_ANALYTICS_SEARCH_PARAMS ADD TENANT_ID VARCHAR2(32)DEFAULT -1';
