...
@&EMSAAS_SQL_ROOT/1.11.0/emaas_savesearch_add_column.sql
...
@&EMSAAS_SQL_ROOT/1.11.0/emaas_savesearch_drop_column.sql
@&EMSAAS_SQL_ROOT/1.11.0/emaas_savesearch_seed_data_ude.sql &TENANT_ID
