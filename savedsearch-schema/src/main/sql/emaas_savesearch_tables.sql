...
CREATE TABLE EMS_ANALYTICS_FOLDERS
  (
    ...
    CONSTRAINT EMS_ANALYTICS_FOLDERS_U01 UNIQUE (NAME, PARENT_ID) USING INDEX,
...
CREATE TABLE EMS_ANALYTICS_CATEGORY
  (
    ...
    CONSTRAINT EMS_ANALYICS_CATEGORY_U01 UNIQUE (NAME) USING INDEX,
...
CREATE TABLE EMS_ANALYTICS_SEARCH
  (
    ...
    CONSTRAINT EMS_ANALYTICS_SEARCH_U01 UNIQUE (NAME, FOLDER_ID, CATEGORY_ID) USING INDEX ,
