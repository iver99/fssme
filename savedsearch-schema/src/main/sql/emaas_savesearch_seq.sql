...
-- 1 -- 1000 is reserved
CREATE SEQUENCE EM_ANALYTICS_FOLDERS_SEQ  MINVALUE 1 MAXVALUE 999999999999999999999999 INCREMENT BY 1 START WITH 1000 CACHE 20 ORDER  NOCYCLE;

-- 1 -- 1000 is reserved
CREATE SEQUENCE EM_ANALYTICS_CATEGORY_SEQ  MINVALUE 1 MAXVALUE 999999999999999999999999 INCREMENT BY 1 START WITH 1000 CACHE 20 ORDER  NOCYCLE;

-- 1 -- 10000 is reserved
CREATE SEQUENCE EM_ANALYTICS_SEARCH_SEQ  MINVALUE 1 MAXVALUE 999999999999999999999999 INCREMENT BY 1 START WITH 10000 CACHE 20 ORDER  NOCYCLE;
