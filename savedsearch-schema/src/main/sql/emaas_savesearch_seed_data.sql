...
Insert into EMS_ANALYTICS_CATEGORY (CATEGORY_ID,NAME,DESCRIPTION,OWNER,CREATION_DATE,NAME_NLSID,NAME_SUBSYSTEM,DESCRIPTION_NLSID,DESCRIPTION_SUBSYSTEM,EM_PLUGIN_ID,DEFAULT_FOLDER_ID) 
                           values (999,'Demo Analytics','Search Category for Demo','ORACLE',SYS_EXTRACT_UTC(SYSTIMESTAMP),'DEMO_ANALYTICS_CATEGORY_NAME','EMANALYTICS','DEMO_ANALYTICS_CATEGORY_DESC','EMANALYTICS','oracle.sysman.core',null);
