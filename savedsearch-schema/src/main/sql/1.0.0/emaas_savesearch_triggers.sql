...
CREATE OR REPLACE TRIGGER  EMS_ANALYTICS_FOLDERS_TR BEFORE INSERT ON EMS_ANALYTICS_FOLDERS   /* NOSONAR */
FOR EACH ROW
BEGIN
...
CREATE OR REPLACE TRIGGER  EMS_ANALYTICS_CATEGORY_TR BEFORE INSERT ON EMS_ANALYTICS_CATEGORY   /* NOSONAR */
FOR EACH ROW
BEGIN
...
CREATE OR REPLACE TRIGGER  EMS_ANALYTICS_SEARCH_TR BEFORE INSERT ON EMS_ANALYTICS_SEARCH   /* NOSONAR */
FOR EACH ROW
BEGIN
