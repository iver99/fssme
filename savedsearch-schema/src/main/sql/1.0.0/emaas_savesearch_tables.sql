...
Rem    aduan       01/14/15 - Add columns to Search and Category table to support widget framework
...
CREATE TABLE EMS_ANALYTICS_FOLDERS
  (
    ...
    CONSTRAINT EMS_ANALYTICS_FOLDERS_PK PRIMARY KEY (FOLDER_ID,TENANT_ID) USING INDEX,
    CONSTRAINT EMS_ANALYTICS_FOLDERS_U01 UNIQUE (NAME, PARENT_ID,DELETED,TENANT_ID,OWNER) USING INDEX,
    CONSTRAINT EMS_ANALYTICS_FOLDERS_FK1 FOREIGN KEY (PARENT_ID,TENANT_ID) REFERENCES EMS_ANALYTICS_FOLDERS (FOLDER_ID,TENANT_ID)    /* NOSONAR */
  )  ;
...
CREATE TABLE EMS_ANALYTICS_CATEGORY
  (
    ...
    CONSTRAINT EMS_ANALYICS_CATEGORY_U01 UNIQUE (NAME,DELETED,TENANT_ID,OWNER) USING INDEX,
    CONSTRAINT EMS_ANALYTICS_CATEGORY_FK1 FOREIGN KEY (DEFAULT_FOLDER_ID,TENANT_ID) REFERENCES EMS_ANALYTICS_FOLDERS (FOLDER_ID,TENANT_ID)    /* NOSONAR */
   )  ;
...
CREATE TABLE EMS_ANALYTICS_CATEGORY_PARAMS
  (
    ...
    TENANT_ID              NUMBER(*,0) NOT NULL,
    CONSTRAINT EMS_ANALYTICS_CAT_PARAMS_PK PRIMARY KEY (CATEGORY_ID,NAME,TENANT_ID) USING INDEX,
    CONSTRAINT EMS_ANALYTICS_CAT_PARAMS_FK1 FOREIGN KEY (CATEGORY_ID,TENANT_ID) REFERENCES EMS_ANALYTICS_CATEGORY (CATEGORY_ID,TENANT_ID)    /* NOSONAR */
   );
...
CREATE TABLE EMS_ANALYTICS_SEARCH
  (
    ...
    TENANT_ID              NUMBER(*,0) NOT NULL, 
    CONSTRAINT EMS_ANALYTICS_SEARCH_PK PRIMARY KEY (SEARCH_ID,TENANT_ID) USING INDEX ,
    CONSTRAINT EMS_ANALYTICS_SEARCH_U01 UNIQUE (NAME, FOLDER_ID, CATEGORY_ID ,DELETED,TENANT_ID,OWNER) USING INDEX ,
    CONSTRAINT EMS_ANALYTICS_SEARCH_FK1 FOREIGN KEY (CATEGORY_ID,TENANT_ID) REFERENCES EMS_ANALYTICS_CATEGORY (CATEGORY_ID,TENANT_ID),
    CONSTRAINT EMS_ANALYTICS_SEARCH_FK2 FOREIGN KEY (FOLDER_ID,TENANT_ID) REFERENCES EMS_ANALYTICS_FOLDERS (FOLDER_ID,TENANT_ID)    /* NOSONAR */
  ) ;
...
CREATE TABLE EMS_ANALYTICS_SEARCH_PARAMS
  (
    ...
    TENANT_ID              NUMBER(*,0) NOT NULL,
    CONSTRAINT EMS_ANALYTICS_SEARCH_PROPS_PK PRIMARY KEY (SEARCH_ID,NAME,TENANT_ID) USING INDEX,
    CONSTRAINT EMS_ANALYTICS_SEARCH_PARAMS_FK FOREIGN KEY (SEARCH_ID,TENANT_ID) REFERENCES EMS_ANALYTICS_SEARCH (SEARCH_ID,TENANT_ID )    /* NOSONAR */
   );
...
CREATE TABLE EMS_ANALYTICS_LAST_ACCESS 
  (
    ...
    CONSTRAINT EMS_ANALYTICS_LAST_ACCESS_PK PRIMARY KEY (OBJECT_ID,ACCESSED_BY,OBJECT_TYPE,TENANT_ID) USING INDEX
  );
