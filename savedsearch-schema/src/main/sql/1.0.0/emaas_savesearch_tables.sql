...
CREATE TABLE EMS_ANALYTICS_FOLDERS
  (
    ...
    CONSTRAINT EMS_ANALYTICS_FOLDERS_FK1 FOREIGN KEY (PARENT_ID,TENANT_ID) REFERENCES EMS_ANALYTICS_FOLDERS (FOLDER_ID,TENANT_ID) 
  )  ;
...
CREATE TABLE EMS_ANALYTICS_CATEGORY
  (
    ...
    CONSTRAINT EMS_ANALYTICS_CATEGORY_FK1 FOREIGN KEY (DEFAULT_FOLDER_ID,TENANT_ID) REFERENCES EMS_ANALYTICS_FOLDERS (FOLDER_ID,TENANT_ID)
   )  ;
...
CREATE TABLE EMS_ANALYTICS_CATEGORY_PARAMS
  (
    ...
    CONSTRAINT EMS_ANALYTICS_CAT_PARAMS_FK1 FOREIGN KEY (CATEGORY_ID,TENANT_ID) REFERENCES EMS_ANALYTICS_CATEGORY (CATEGORY_ID,TENANT_ID)
   );
...
CREATE TABLE EMS_ANALYTICS_SEARCH
  (
    ...
    CONSTRAINT EMS_ANALYTICS_SEARCH_FK2 FOREIGN KEY (FOLDER_ID,TENANT_ID) REFERENCES EMS_ANALYTICS_FOLDERS (FOLDER_ID,TENANT_ID) 
  ) ;
...
CREATE TABLE EMS_ANALYTICS_SEARCH_PARAMS
  (
    ...
    CONSTRAINT EMS_ANALYTICS_SEARCH_PARAMS_FK FOREIGN KEY (SEARCH_ID,TENANT_ID) REFERENCES EMS_ANALYTICS_SEARCH (SEARCH_ID,TENANT_ID )
   );
