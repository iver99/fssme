...
Insert into EMS_ANALYTICS_CATEGORY (CATEGORY_ID,NAME,DESCRIPTION,OWNER,CREATION_DATE,NAME_NLSID,NAME_SUBSYSTEM,DESCRIPTION_NLSID,DESCRIPTION_SUBSYSTEM,EM_PLUGIN_ID,DEFAULT_FOLDER_ID) 
                           values (4,'APMCS','Search Category for Application Performance Monitoring Cloud Service','ORACLE',SYS_EXTRACT_UTC(SYSTIMESTAMP),'APMCS_CATEGORY_NAME','EMANALYTICS','APMCS_CATEGORY_DESC','EMANALYTICS','oracle.sysman.core',5);
